...
ggplot(child_adult, aes(x = child_rate, y = adult_rate)) +
  ...
  labs(
    title = "Higher Child Food Insecurity Rates Associated With Higher Adult Food Insecruity Rates Across States",
